...
public class hukukMuvekkildavahareketrapor_cagir {
	...
	public void rapor(String sayi) {
		...
		try 
		{
			...
			String listele="Select A.MuvekkilTC,A.DavaNo,A.DavaninAcilisTarihi,A.DosyaNo,A.DavaMahkemesi,A.DavaKonusu,A.DavaAvukati,A.DurusmaTarihi,A.DurusmaSaati,A.hatirlat,A.hakedis,A.Aciklama,B.MuvekkilAdi,B.MuvekkilSoyadi From muvekkildavahareket A,muvekkilbilgi B where A.MuvekkilTC=B.MuvekkilTC and A.DavaNo='"+sayi+"'"; 
