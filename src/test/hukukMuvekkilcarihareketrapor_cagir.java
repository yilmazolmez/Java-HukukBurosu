...
public class hukukMuvekkilcarihareketrapor_cagir {
	...
	public void rapor(String sayi) {
		...
		try 
		{
			...
			String listele="Select A.MuvekkilTC,A.Muvekkilcarihareketno,A.Muvekkilborctutar,A.Muvekkilalacaktutar,A.islemtarihi,A.hatirlat,A.hakedis,A.Aciklama,B.MuvekkilAdi,B.MuvekkilSoyadi From muvekkilcarihareket A,muvekkilbilgi B where A.MuvekkilTC=B.MuvekkilTC and A.Muvekkilcarihareketno='"+sayi+"'"; 
			...
			rs1=mystat1.executeQuery(listele);
				...
				{	
					...
					PdfWriter pdfWriter = PdfWriter.getInstance(document, new FileOutputStream(path+"\\muvekkilcarihareket.pdf"));
					document.open();
					//ekrana yazýlar basýlýyor
					document.add(new Paragraph("SECILEN CARI HAREKET DETAY BILGILERI :"));
			         ...
			         List list = new List(List.UNORDERED);
			            ...
			            list.add(new ListItem("Islem Tarihi="+rs1.getString("islemtarihi")));
			            list.add(new ListItem("---------------------------------------------------------------------------------------------------------"));
			            list.add(new ListItem("Hatirlatma Tarihi="+rs1.getString("hatirlat")));
			            list.add(new ListItem("Borc Tutari="+rs1.getString("Muvekkilborctutar")));
			            list.add(new ListItem("Alacak Tutari="+rs1.getString("Muvekkilalacaktutar")));
			            list.add(new ListItem("---------------------------------------------------------------------------------------------------------"));
			       ...
			       // String FILE = "C:\\Users\\yýlmaz\\eclipse-workspace\\Deneme\\avukatbilgi.pdf";
			        String FILE = path+"\\muvekkilcarihareket.pdf";
					try 
					{
